    ...
    <div>
        <div class="model_topcol" style="position: relative;">
            ...
            <div style="position: absolute; right: 10px; z-index: 999; top: 0">
                <el-button @click="addEvent" :style="{width: '90px'}" type="primary" size="small">新增</el-button>
            </div>
        </div>
            ...
            <div class="model_content_inner">
                <el-card v-show="isSupperBoxShow" class="box_card">
                    ...
                    <el-form :inline="true" :model="tableParam" label-position="right" size="small" label-width="100px">
                        <el-form-item label="采购单号">
                            <el-input v-model="tableParam.orderNo" placeholder="请输入采购单号" style="width: 250px"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="发票状态">
                            <el-select v-model="tableParam.financeStatus" placeholder="请选择发票状态">
                                <el-option label="全部" value=""></el-option>
                                <el-option label="待收" value="0"></el-option>
                ...
                <el-table
                    ...
                    <el-table-column
                       ...
                       >
                       <template slot-scope="scope">
                            <span class="color_red" v-if="scope.row.invoiceStatus == 0">待收</span>
                            <span v-if="scope.row.invoiceStatus == 1">已收</span>
                            <span v-if="scope.row.invoiceStatus == 2">已作废</span>
                        </template>
                    </el-table-column>
                    <el-table-column
                        prop="prop"
        ...
        <el-dialog
           ...
           >
                <div>
                    ...
                    <span style="vertical-align: text-bottom;">确定将此发票作废？发票作废后状态不可退回？</span><br>
                    <span style="margin-left: 32px">如确定作废，请填写作废原因：</span>
                </div>
        ...
        <el-dialog
           ...
           >
            <div>
                <p>上传完发票图片，默认已收到发票。请上传小于2M的图片。</p>
...
export default {
    ...
    methods:{
        ...
        gatherEvent() {
            ...
            api.comfirmInvoice(paramobj).then((response) => {
        ...
        invalidateEvent() {
            ...
            api.invalidInvoice(paramobj).then((response) => {
        ...
        getTableData(){
            api.getInvoiceList(this.tableParam).then((response) => {
