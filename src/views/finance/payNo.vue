<template>
    <div>
        <div class="model_topcol" style="position: relative;">
            <span style="color: #409EFF">采购付款单</span>
            ...
            <div class="model_content_inner">
                <el-card v-show="isSupperBoxShow" class="box_card">
                    ...
                    <el-form :inline="true" :model="tableParam" label-position="right" size="small" label-width="100px">
                        <el-form-item label="付款单号">
                            <el-input v-model="tableParam.financeNo" placeholder="请输入付款单号" style="width: 250px"></el-input>
                        </el-form-item>
                ...
                <el-table
                    ...
                    <el-table-column
                       ...
                       >
                       <template slot-scope="scope">
                            <span class="" v-if="scope.row.financeStatus == 1">已付款</span>
        ...
        <el-dialog
           ...
           >
                <div>
                    ...
                    <span style="vertical-align: text-bottom;">确定将付款单号 <span v-text="currentTableData.financeNo"></span> (付款金额:<span v-text="currentTableData.financeMoney"></span>) 作废？</span><br>
                    <span style="margin-left: 32px">付款单作废后状态不可退回。如确定作废，请填写作废原因：</span>
                </div>
...
export default {
    ...
    methods:{
        ...
        gatherEvent() {
            ...
            api.addExtrueImg(paramobj).then((response) => {
