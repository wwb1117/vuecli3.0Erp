        ...
        <div class="model_content">
            <div class="tab_content">
                <div class="tab_title fontWe_600">
                    <span v-if="dataInfo.financeStatus == 1" class="title_states">已付款</span>
                    <span v-if="dataInfo.financeStatus == 2" class="title_states">已作废</span>
                    <span style="margin-left: 30px" class="title_title">付款单号 : </span>
                    ...
                    <span class="title_title">开户名称 : </span>
                    <span class="title_data" v-text="dataInfo.accountName"></span>
                    <span class="title_title">开户银行 : </span>
                    <span class="title_data" v-text="dataInfo.bankName"></span>
                    <span class="title_title">银行账号 : </span>
                    <span class="title_data" v-text="dataInfo.accountNumber"></span>
                </div>
                <div class="banner">
                    付款单信息
                </div>
