        ...
        <div class="banner">
            <el-form :inline="true" :model="tableParam" label-position="right" size="small" label-width="80px">
                <el-form-item label="商品分类">
                    <el-select v-model="tableParam.categoryId" placeholder="请输入商品分类" @change="searchInputClear">
                ...
                <el-form-item>
                    ...
                    <el-button :style="{margin: '0 10px'}" type="primary" size="small" @click="searchInputClear">搜索</el-button>
                </el-form-item>
            </el-form>
        </div>
        <div class="content">
