                ...
                <div class="table_wrap" :style="{height: $store.state.home.modelContentHeight - 125 + 'px'}">
                    ...
                    <div class="table_bottom">
                        <div class="table_bottom_item" :style="{marginBottom :'10px'}">
                            <span class="table_bottom_title">调入仓库 : </span>
                            <span :style="{marginRight :'50px'}">{{tableData.inventoryInHouseName}}</span>
                            <span class="table_bottom_title">调出仓库 : </span>
                            <span>{{tableData.inventoryOutHouseName}}</span>
                        </div>
