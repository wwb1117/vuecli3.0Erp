                ...
                <el-card v-show="isSupperBoxShow" class="box_card">
                    ...
                    <el-form class="myForm" :inline="true" :model="searchFormData" label-position="right" size="small" label-width="80px">
                        ...
                        <el-form-item label="商品品牌">
                            <el-select filterable v-model="searchFormData.brandId" placeholder="请选择商品品牌">
                                <el-option
                        ...
                        <!-- <el-form-item label="供应商">
                            <el-select filterable v-model="searchFormData.sellerId" placeholder="请选择供应商">
...
export default {
    ...
    activated() {
        ...
        if (this.$route.params.type == 2) {
            this.searchFormData.houseStatus = this.$route.params.status
            this.search()
        } else {
            this.getTableList()
        }
