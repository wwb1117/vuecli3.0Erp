...
<!-- 新增收货地址 -->
        ...
        <div class="model_footer">
            <el-button @click="addOrderListEvent" type="primary" size="small" style="width: 90px; margin-left: 25px;">保 存</el-button>
            <el-button size="small" @click="addOrderListBack" style="width: 90px;">取 消</el-button>
        </div>
    </div>
</template>
