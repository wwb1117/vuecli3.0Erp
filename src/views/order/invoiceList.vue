        ...
        <div class="model_content" :style="{height: $store.state.home.modelContentHeight + 'px'}">
            <div class="model_content_inner">
                <div class="invoiceList_title">
                    ...
                    <el-button :style="{margin: '0 30px 0 10px'}" type="primary" size="small" @click='initGetTableData'>搜索</el-button>
                </div>
                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        label="状态">
                        <template slot-scope="scope">
                            <span v-if="scope.row.status == 0" class="color_brown">待收货</span>
                            <span v-if="scope.row.status == 1">已收货</span>
                        </template>
                    </el-table-column>
                </el-table>
