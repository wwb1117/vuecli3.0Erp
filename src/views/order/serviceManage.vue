                                ...
                                <el-row>
                                    ...
                                    <el-col class="order_goods_wrap_left" :span="15">
                                        <el-row type="flex" align="middle" class="waitMerger_order_goods">
                                            <el-col :span="6" v-text="item.itemName"></el-col>
                                            <el-col :span="5" v-text="item.specsMsg"></el-col>
                                            <el-col style="padding-left: 30px" :span="4">{{item.price}}</el-col>
                                            <el-col :span="2">{{item.quantity}}</el-col>
                                            <el-col class="orderCosts" :span="4">
                                                <span class="color_red">{{item.refundPrice}}</span><br>
                                                <span>含运费 : </span>
                                    ...
                                    <el-col class="order_goods_wrap_right" :span="9">
                                        <el-row type="flex" align="middle">
                                            <el-col class="" :span="6">
                                                <span>
                                                    <span v-if="item.secondaryStatus == 0" >待付款</span>
                                            ...
                                            <el-col class="propButton_wrap" :span="6">

                                                <el-button type="primary" size="mini" v-perss="'同意退款'" @click.native.prevent="operaEvent(item.secondaryOrderNo, 3, item.refundNo)" v-if="item.refundType == 0 && item.afterStatus == 1 && item.supplierStatus == 1">同意退款</el-button>
                                                <el-button size="mini" v-perss="'拒绝退款'" @click.native.prevent="operaEvent(item.secondaryOrderNo, 5, item.refundNo)" v-if="item.refundType == 0 && item.afterStatus == 1 && item.supplierStatus == 1">拒绝退款</el-button>

                                                <el-button type="primary" size="mini" v-perss="'同意退货'" @click.native.prevent="operaEvent(item.secondaryOrderNo, 4, item.refundNo)" v-if="item.refundType == 2 && item.afterStatus == 1 && item.supplierStatus == 1">同意退货</el-button>
                                                <el-button size="mini" v-perss="'拒绝退款'" @click.native.prevent="operaEvent(item.secondaryOrderNo, 6, item.refundNo)" v-if="item.refundType == 2 && item.afterStatus == 1 && item.supplierStatus == 1">拒绝退货</el-button>

                                                <el-button type="primary" size="mini" v-perss="'同意退款'" @click.native.prevent="operaEvent(item.secondaryOrderNo, 3, item.refundNo)" v-if="item.refundType == 2 && item.afterStatus == 3">同意退款</el-button>
                                                <el-button size="mini" v-perss="'拒绝退款'" @click.native.prevent="operaEvent(item.secondaryOrderNo, 5, item.refundNo)" v-if="item.refundType == 2 && item.afterStatus == 3">拒绝退款</el-button>

                                                <el-button type="primary" size="mini" v-perss="'同意退款'" @click.native.prevent="operaEvent(item.secondaryOrderNo, 3, item.refundNo)" v-if="item.refundType == 1 && item.afterStatus == 1 && item.supplierStatus == 1">同意退款</el-button>
                                                <el-button size="mini" v-perss="'拒绝退款'" @click.native.prevent="operaEvent(item.secondaryOrderNo, 5, item.refundNo)" v-if="item.refundType == 1 && item.afterStatus == 1 && item.supplierStatus == 1">拒绝退款</el-button>
                                                ...
                                                <el-button type="text" style="margin-left: 15px" size="small" v-perss="'订单详情'" @click.native.prevent="operaEvent(item.secondaryOrderNo, 2, item.refundNo)">订单详情</el-button>
