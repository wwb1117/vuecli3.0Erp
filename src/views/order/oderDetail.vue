        ...
        <div class="model_content" :style="{height: $store.state.home.modelContentHeight + 'px'}">
            <div class="model_content_inner">
                ...
                <div style="height: 81px; line-height: 81px; padding-left: 20px; margin-top: 40px" class="color_red">
                    <span>当前订单状态 : </span>
                    <span v-if="orderInfo.secondaryStatus == 0">待付款</span>
                    ...
                    <el-table
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope" >
                                <img v-if="scope.row.itemImg" :src="scope.row.itemImg" style="float: left;width: 50px; height: 50px; margin-right: 10px">
                ...
                <div class="opert_conten" style="padding: 20px">
                    <el-table
                        ...
                        <el-table-column
                            ...
                            label="付款状态">
                            <template slot-scope="scope">
                                <span v-if="scope.row.payStatus == 0">待付款</span>
