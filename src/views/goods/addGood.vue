        ...
        <div class="model_content">
            <div class="model_content_inner" :style="{height: $store.state.home.modelContentHeight - 20 + 'px', overflow: 'auto'}">
                <el-form :inline="true" class="myForm" ref="addGoodForm" :rules="rules" :model="addFormData" label-position="right" size="small" label-width="120px">
                    ...
                    <el-form-item prop="categoryIdArr" label="商品分类">
                        <el-cascader
                            :disabled="true"
                            placeholder="请选择商品分类"
                    ...
                    <div style="display: inline-block; padding-top: 5px;">
                        <span class="color_red">注: </span><span>下架时间需早于过期时间一个月</span>
                    </div>
                    <br>
                        ...
                        <el-row style="margin-bottom: 20px">
                            ...
                            <el-col class="boxBorder padding10" :span="22">
                                <div class="goodSkuBackGround padding10 relative">
                                    ...
                                    <el-select filterable size="small" @change="goodPackNameChangeEvent" v-model="supplyProperty.id" placeholder="请选择类型名">
                                        <el-option
                                ...
                                <div>
                                    ...
                                    <div v-for="(item, index) in supplyProperty.itemSupplyPropertyDTOS" :key="index" class="padding10 relative inline">
                                        <i @click="removeGoodPackValueItem(index)" class="el-icon-error icon_position"></i>
                                        <el-select size="small" v-model="item.id" @change="goodPackValueChangeEvent(index)" placeholder="请选择规格值">
                                            <el-option
                    ...
                    <div>
                        <el-row style="margin-bottom: 20px" class="relative" v-for="(item, index) in addFormData.property" :key="index">
                            ...
                            <el-col class="relative" style="margin-left: 20px;" :span="10">
                    ...
                    <div>
                        <el-form-item label="" class="goodImgWrap pic_up">
    ...
    methods:{
        ...
        getPromotesList() { // 获取提成设置
            api.getitempromotes().then(res => {
                ...
                this.deductoptions.unshift({
                    promoteGroupId: '',
                    promoteGroupName: '选择类型'
                })
            })
        },
        ...
        addGoodSaveEvent(){
            this.$refs['addGoodForm'].validate((valid) => {
                if (valid) {
                    ...
                    paramobj.supplyProperty = JSON.stringify([this.supplyProperty]) //商品包装类型
                    ...
                    paramobj.mainImg = imgArr[0].imgUrl
                    ...
                    api.postitemadd(paramobj).then((res) => {
                        this.$refs['addGoodForm'].clearValidate()
                        this.$message({
                            type: 'success',
                            duration: 1500,
                    ...
                    setTimeout(()=>{
                        let isError = document.getElementsByClassName("is-error")[0];

                        isError.querySelector('input').focus();
                        let top = $('.is-error').eq(0).offset().top

                        $('.is-error').eq(0).scrollTop(top)
