      ...
      <div class="main_content">
          ...
          <div class="main_cont_right">
              ...
              <ul class="main_cont_right_ul" id="main_cont_preGood">
                  <li class="myCur" @click="skipEvent(6)">商品库存高于上限<el-badge :value="baseData.totalUpper" :max="10"></el-badge></li>
                  <li class="myCur" @click="skipEvent(7)">商品库存低于下限<el-badge :value="baseData.totalLower" :max="10"></el-badge></li>
                  <li class="myCur" @click="skipEvent(8)">商品效期预警<el-badge :value="baseData.totalOutter" :max="10"></el-badge></li>
              </ul>
          </div>
      </div>
  </div>
