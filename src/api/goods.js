...
export default {
    ...
    getGoodTemDetail(data){
        return HttpClient.get(`/template/${data}`)
    },
    getGoodPackList(data){
        return HttpClient.get('/item/supplyProperty/itemSupplyPropertyList', data)
    },
    getTransportList(data){
        return HttpClient.get('/transport/list', data)
    },
    // 商品分类！
    // 查询商品分类列表
    ...
    // 商品规格！
    //获取商品所有规格列表
    getItemTotalSkuList(data){
        return HttpClient.get('/item/skuProperty/itemSkuPropertyList', data)
    },
    // 获取商品规格值列表
    ...
    // 添加赠品
    addGive(data) {
        return HttpClient.put('/item/gift/add', data)
    },
    //修改赠品
    editGive(data){
        return HttpClient.put('/item/gift/update', data)
    },
    // 编辑商品
    putitemupdate(data) {
        return HttpClient.post('/item/update', data)
    },
    //获取商品详情
    getGoodDetail(itemId){
